...
class AIOInfoGrabber:
    def __init__(self, users: list,
        ...
        # Сколько запросов к API сделать за round_seconds секунд
        # Задержка ответа на запрос о пользователях - 5 секунд
        ...
        self.users_info_url = 'https://api.vk.ru/method/execute.users_info'
    ...
    async def start(self, method: Literal['users']) -> tuple[dict[str, bool], bool]:
        """
        ...
        # Возвращаем словарь достигнутых лимитов и нужно ли повторение
    ...
    async def users_info_process(self, users_id):
        ...
        # Если профиль есть в списке профилей, но по нему нет информации, то его нужно перепроверить
